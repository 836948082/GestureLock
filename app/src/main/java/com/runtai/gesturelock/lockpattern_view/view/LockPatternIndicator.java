package com.runtai.gesturelock.lockpattern_view.view;
...
public class LockPatternIndicator extends View {
	...
	public void setDefaultIndicator() {
		Log.e("mIndicatorCells.length",""+mIndicatorCells.length);
		for(int i = 0; i < mIndicatorCells.length; i++) {
			Log.e("mIndicatorCells[i].length",""+mIndicatorCells[i].length);
			for(int j = 0; j < mIndicatorCells[i].length; j++) {
